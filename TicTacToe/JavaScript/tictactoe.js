...
let activePlayer = 'X';
//This array stores an array of moves.We ise this to determine win conditions.
let selectedSquares = [];

//This function is for placing an c or o in a square.
function placeXOrO(squareNumber) {
    //This condidtion ensures a square hasn't been selected already.
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //This variable retrives the HTML element id that is clicked.
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows or while loop to keep trying if a square is selected already.
        while (!success) {
            //A random numner between 0 and 8 is selected.
...
function checkWinConditions() {
    ...
    // O 0, 1, 2 condition
    else if (arrayIncludes('O0', '1O', '2O')) { drawWineLine(50, 100, 558, 100) }
    //O 3, 4, 5 condition
    ...
    //This condition checks for a tie. If none of the above conditions are net and
    //9 squares are selected the code executes.
    else if (selectedSquares.length >= 9) {
        //This function plays the tie game sound.
        Audio('./Media/tie.mp3');
        //This funtion sets a .3 second timer before the resetGame is called.
        setTimeout(function () { resetGame(); }, 500);
    }
    //This function checks if an array includes 3 stings. It is used to check for
    //each win condition.
...
function resetGame() {
    ...
    //This resets our array to it is empty and we can start over.
    selectedSquares = [];
}
...
function drawWineLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        //This line indicates where the start of a lines y axis id.
        y1 = coordY1,
    ...
    //This line disallows clicking while the win dound is playing.
    disableClick();
